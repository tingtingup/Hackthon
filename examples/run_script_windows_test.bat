...
..\dist\win64_bin\global_registration.exe -f target/25um/CCF_u8_xpad.v3draw -c target/CCF_mask.v3draw ^
...
^ -m subject/fMOST_segmentation/ -l target/25um/target_landmarks/high_landmarks.marker  -g target/25um/ -o result/fMOST/
